...
import classes from "./robot.css";
const Robot = () => {
    return(
        <div className={classes.container}>
        <div className={classes.robot}><svg version="1.1" xmlns="http://www.w3.org/2000/svg">
            <g id={classes.hover}>
              <ellipse id="shadow_2_" opacity="0.4" fill="#2C3332" cx={300} cy="703.375" rx="88.971" ry="30.625" />
            </g>
            <g id={classes.arms}>
              <g id={classes.left}>
                <path id={classes.arm_1_} fill="#BABEB7" d="M183.975,430.936c-50.27-21.595-96.437,29.654-96.132,54.383
                ...
                <g id="hand_1_">
                  <path id={classes.shadow} fill="#BABEB7" d="M63.712,520.545l5.657-7.071c0,0-11.453-8.997-9.402-12.554
                  ...
                  <path id={classes.top} fill="#DCE0DA" d="M69.37,513.474c-5.443-5.817-7.202-13.631-3.746-19.625c4.469-7.751,15.935-9.514,25.612-3.935
            ...
            <g id={classes.body}>
              <g id={classes.chassie}>
                ...
                <g id={classes.highlight}>
                  <defs>
                    {/* don't change path id - makes a weird block appear */}
